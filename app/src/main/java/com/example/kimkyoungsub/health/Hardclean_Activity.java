...
public class Hardclean_Activity extends AppCompatActivity {
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.hardclean_layout);
        ...
        Glide.with(this).load(R.drawable.hardclean1).into(gifImage);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case R.id.recordicon:
                Intent intent = new Intent(Hardclean_Activity.this,DetailRecord.class);
