...
public class Crunch_Activity extends AppCompatActivity {
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Glide.with(this).load(R.drawable.crunch11).into(gifImage);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case R.id.recordicon:
                Intent intent = new Intent(Crunch_Activity.this,DetailRecord.class);
