...
public class Armwalking_Activity extends AppCompatActivity {
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.armwalking_layout);
        ...
        Glide.with(this).load(R.drawable.armwalking1).into(gifImage);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case R.id.recordicon:
                Intent intent = new Intent(Armwalking_Activity.this,DetailRecord.class);
