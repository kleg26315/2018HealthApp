...
public class Legraise_Activity extends AppCompatActivity {
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.legraise_layout);
        ...
        Glide.with(this).load(R.drawable.legraise11).into(gifImage);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case R.id.recordicon:
                Intent intent = new Intent(Legraise_Activity.this,DetailRecord.class);
