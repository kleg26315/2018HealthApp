...
public class Legpress_Activity extends AppCompatActivity {
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.legpress_layout);
        ...
        Glide.with(this).load(R.drawable.legpress1).into(gifImage);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case R.id.recordicon:
                Intent intent = new Intent(Legpress_Activity.this,DetailRecord.class);
