...
public class Pushup_Activity extends AppCompatActivity {
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Glide.with(this).load(R.drawable.pushup1).into(gifImage);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case R.id.recordicon:
                Intent intent = new Intent(Pushup_Activity.this,DetailRecord.class);
